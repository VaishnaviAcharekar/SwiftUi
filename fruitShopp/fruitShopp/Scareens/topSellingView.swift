...
struct topSellingView: View {
    ...
    let image : [fruitModel] = [ .init(id: 0, title: .apple, image: "apple", price: "$1.99 each", color: "1"),
                                 ...
                                 .init(id: 17, title: .pinepple, image: "pineapple", price: "$2.84 each", color: "6"),
    ...
    var body: some View {
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(alignment: .center, spacing: 20){
                ForEach(image, id: \.id) { post in
                    
                    NavigationLink {
                        detailView(fruit: post.title)
                    } label: {
